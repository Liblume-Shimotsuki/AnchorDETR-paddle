...
class Trainer(object):
    def __init__(self, cfg, mode='train'):
        ...
        self.acum_steps = self.cfg.get('acum_steps', 1)
        # build data loader
        ...
        for epoch_id in range(self.start_epoch, self.cfg.epoch):
            ...
            for step_id, data in enumerate(self.loader):
                ...
                if self.cfg.get('amp', False):
                    ...
                    loss = outputs['loss']
                    # model backward
                    loss = loss / self.acum_steps
                    loss.backward()
                    if (step_id + 1) % self.acum_steps == 0:
                        self.optimizer.step()
            ...
            if self.cfg.get('on_epoch_end', None):
                try:
                    import subprocess
                    proc = subprocess.Popen(self.cfg.on_epoch_end, shell=True)
